...
public class GatewayProperties {
    ...
    private int masterChangeBodySizeLimitBytes = 5 * 1024 * 1024;
    ...
    public int getMasterChangeBodySizeLimitBytes() {
        return masterChangeBodySizeLimitBytes;
    }

    public void setMasterChangeBodySizeLimitBytes(int masterChangeBodySizeLimitBytes) {
        this.masterChangeBodySizeLimitBytes = masterChangeBodySizeLimitBytes;
    }

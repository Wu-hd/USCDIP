...
public enum ErrorCode {
    ...
    ACCOUNT_CONFLICT("ACCOUNT_CONFLICT", "Account conflicts with an existing identity"),
    ACCOUNT_INVALID_OPERATION("ACCOUNT_INVALID_OPERATION", "Account operation is not allowed"),
    ...
    ALERT_RULE_NOT_FOUND("ALERT_RULE_NOT_FOUND", "Alert rule was not found"),
    ALERT_RULE_INVALID("ALERT_RULE_INVALID", "Alert rule is invalid"),
    ALERT_EVALUATION_INVALID("ALERT_EVALUATION_INVALID", "Alert evaluation request is invalid"),
    ALERT_RECORD_NOT_FOUND("ALERT_RECORD_NOT_FOUND", "Alert record was not found"),
    ...
    MODEL_NOT_FOUND("MODEL_NOT_FOUND", "Model was not found"),
    MODEL_VERSION_NOT_FOUND("MODEL_VERSION_NOT_FOUND", "Model version was not found"),
    MODEL_GATEWAY_INVALID("MODEL_GATEWAY_INVALID", "Model gateway request is invalid"),
    MODEL_GATEWAY_CONFLICT("MODEL_GATEWAY_CONFLICT", "Model gateway state conflicts with existing data"),
